  ...
  <div class="container">
    <div class="table-wrapper">
      <table>
        <thead>
          <tr>
            <th v-for="(thing, index) in infoTableArray" :key="index">{{ thing }}</th>
          </tr>
        </thead>
        <tbody>
          <tr v-for="user in list" :key="user._id">
            <td v-for="(propertyName, index) in infoTableArray" :key="index">{{ user[propertyName as keyof User] }}</td>
